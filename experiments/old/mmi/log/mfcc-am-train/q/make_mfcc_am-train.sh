...
( echo '#' Running on `hostname`
  ...
  echo -n '# '; cat <<EOF
compute-mfcc-feats --verbose=2 --config=conf/mfcc.conf scp,p:/scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-am-train/wav_am-train.${SLURM_ARRAY_TASK_ID}.scp ark:- | copy-feats --compress=true ark:- ark,scp:/scratch/work/moisioa3/conv_lm/experiments/mmi/mfcc/raw_mfcc_am-train.${SLURM_ARRAY_TASK_ID}.ark,/scratch/work/moisioa3/conv_lm/experiments/mmi/mfcc/raw_mfcc_am-train.${SLURM_ARRAY_TASK_ID}.scp 
EOF
) >/scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-am-train/make_mfcc_am-train.$SLURM_ARRAY_TASK_ID.log
...
time1=`date +"%s"`
 ( compute-mfcc-feats --verbose=2 --config=conf/mfcc.conf scp,p:/scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-am-train/wav_am-train.${SLURM_ARRAY_TASK_ID}.scp ark:- | copy-feats --compress=true ark:- ark,scp:/scratch/work/moisioa3/conv_lm/experiments/mmi/mfcc/raw_mfcc_am-train.${SLURM_ARRAY_TASK_ID}.ark,/scratch/work/moisioa3/conv_lm/experiments/mmi/mfcc/raw_mfcc_am-train.${SLURM_ARRAY_TASK_ID}.scp  ) 2>>/scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-am-train/make_mfcc_am-train.$SLURM_ARRAY_TASK_ID.log >>/scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-am-train/make_mfcc_am-train.$SLURM_ARRAY_TASK_ID.log
ret=$?
time2=`date +"%s"`
