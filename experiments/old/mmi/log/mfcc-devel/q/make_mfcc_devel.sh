...
[ $ret -eq 137 ] && exit 100;
touch /scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-devel/q/done.12681.$SLURM_ARRAY_TASK_ID
exit $[$ret ? 1 : 0]
## submitted with:
# sbatch --export=PATH,LIBRARY_PATH,LD_LIBRARY_PATH,CUDA_HOME,CUDA_PATH,PYTHONPATH  --partition coin,batch --time 1:00:00 --mem-per-cpu 3G  --open-mode=append -e /scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-devel/q/make_mfcc_devel.log -o /scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-devel/q/make_mfcc_devel.log --array 1-20 /scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-devel/q/make_mfcc_devel.sh >>/scratch/work/moisioa3/conv_lm/experiments/mmi/log/mfcc-devel/q/make_mfcc_devel.log 2>&1
