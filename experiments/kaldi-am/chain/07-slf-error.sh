...
lattice-tool \
  -in-lattice-list "${PROJECT_DIR}/lattices/devel/chain-baseline/lattice-list" -read-htk \
...
lattice-tool \
  -in-lattice-list "${PROJECT_DIR}/lattices/eval/chain-baseline/lattice-list" -read-htk \
