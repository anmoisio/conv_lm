...
# print the kaldi repository version for logging
git --git-dir=/scratch/work/moisioa3/conv_lm/kaldi/.git log -n 1
...
train_set=am-train_sp_hires
ali_dir=exp/tri4b_ali_am-train$suffix
...
data/lang exp/tri4b exp/tri4b_lats$suffix
rm exp/tri4b_lats$suffix/fsts.*.gz # save space
