...
if [[ ! -s $lang/tmp/LG.fst || $lang/tmp/LG.fst -ot $lang/G.fst || \
  ...
  fsttablecompose "$lang/L_disambig.fst" "$lang/G.fst" >"$lang/tmp/__a.fst"
  fstdeterminizestar --use-log=true <"$lang/tmp/__a.fst" >"$lang/tmp/__b.fst"
  fstminimizeencoded <"$lang/tmp/__b.fst" >"$lang/tmp/__c.fst"
  fstpushspecial <"$lang/tmp/__c.fst" >"$lang/tmp/__d.fst"
  fstarcsort --sort_type=ilabel <"$lang/tmp/__d.fst" >"$lang/tmp/LG.fst"
  rm "$lang/tmp/__"?.fst
...
if [[ ! -s $dir/HCLG.fst || $dir/HCLG.fst -ot $dir/HCLGa.fst ]]; then
  add-self-loops --self-loop-scale=$loopscale --reorder=true \
    $model < $dir/HCLGa.fst > $dir/HCLG.fst
